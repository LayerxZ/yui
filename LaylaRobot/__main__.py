...
PM_START_TEXT = """
──「 [Nightingale](https://telegra.ph/file/a8f7867a55f2fa1907feb.jpg) 」──

*Yoshaa! {},*
*I'm Anime Lover 😎😎 themed group management bot /help ××
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Tambahkan Ke Grub Anda ➕️", url="t.me/OdaRobot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="✯ Anime Group ✯", url=f"https://t.me/wibuempireindo"),
        InlineKeyboardButton(
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Nightingale*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Support Group @wibuempireindo
                 \n❍ Assistant @Llogvbiu.
                 \nHere is the [Author](https://t.me/Llogvbiu).
                 \n\nIf you have any question about Nightingale, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😎 I'm *Nightingale*
                 \nHere is the [Author](https://github.com/primzzhz) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1314179026 and DONATION_LINK:
            update.effective_message.reply_text(
